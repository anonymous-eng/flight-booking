...
export const NOTES_SEARCH_REQUEST = "NOTES_SEARCH_REQUEST";
export const NOTES_SEARCH_SUCCESS = "NOTES_SEARCH_SUCCESS";
export const NOTES_SEARCH_FAIL = "NOTES_SEARCH_FAIL";

export const NOTES_BOOK_REQUEST = "NOTES_BOOK_REQUES";
export const NOTES_BOOK_SUCCESS = "NOTES_BOOK_SUCCESS";
export const NOTES_BOOK_FAIL = "NOTES_BOOK_FAIL";
